<script>
    ...
    import {Bike, CircleCheckIcon, CircleHelpIcon, CircleIcon, Backpack, Guitar, MountainSnow, Sun, Moon} from "lucide-svelte";
...
<nav class="flex flex-col w-full mx-auto -x">
    <div class="text-foreground mt-4 ml-6 mr-6">
